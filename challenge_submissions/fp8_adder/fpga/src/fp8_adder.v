...
// 4096*8/50MHz = 655 us   4096*8/54.5MHz = 601 us   4096*8/60MHz = 546 us
// ============================================================================
...
module fp8_adder (
    ...
    // ---- Wire: compute sum from a/b inputs (TC holds them stable on start) --
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            case (state)
                S_IDLE: begin
                    if (start) begin
                        // Decode + add in one cycle; TC holds a/b stable while busy
